              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <a href="{{ route('teachers.index') }}" class="btn btn-success btn-rounded btn-fw">View Teachers</a>
                     ...
                     --}}
                      <div class="form-group">
                        ...
                        <div class="input-group col-xs-12">
                          <input type="file" class="file-upload-browse btn btn-primary" placeholder="Upload Image" name="image" required>
